...
For models that do not have a verbosity parameter, this property has no effect.
...
For models that do not have a reasoning effort parameter, this property has no effect.
