    ...
    methods(Test)
        ...
        function constructChatWithAllNVP(testCase)
            ...
            chat = openAIChat(systemPrompt, Tools=functions, ModelName=modelName, ...
                ...
                Verbosity=verbosity, ReasoningEffort=reasoningEffort);
            ...
            testCase.verifyEqual(chat.Verbosity, verbosity);
            testCase.verifyEqual(chat.ReasoningEffort, reasoningEffort);
        end
...
invalidValuesSetters = struct( ...
    ...
    "FrequencyPenaltyTooSmall", struct( ...
        ...
        "Error", "MATLAB:notGreaterEqual"), ...
    ...
    "InvalidVerbosityValue", struct( ...
        "Property", "Verbosity", ...
        "Value", "invalid", ...
        "Error", "MATLAB:validators:mustBeMember"), ...
    ...
    "InvalidVerbosityType", struct( ...
        "Property", "Verbosity", ...
        "Value", 123, ...
        "Error", "MATLAB:validators:mustBeMember"), ...
    ...
    "InvalidReasoningEffortValue", struct( ...
        "Property", "ReasoningEffort", ...
        "Value", "invalid", ...
        "Error", "MATLAB:validators:mustBeMember"), ...
    ...
    "InvalidReasoningEffortType", struct( ...
        "Property", "ReasoningEffort", ...
        "Value", 123, ...
        "Error", "MATLAB:validators:mustBeMember"));
end
...
validConstructorInput = struct( ...
    ...
    "Verbosity", struct( ...
        "Input",{{"APIKey","this-is-not-a-real-key","ModelName","gpt-5.2","Verbosity","auto"}}, ...
        "ExpectedWarning", '', ...
        "VerifyProperties", struct( ...
                "Temperature", {1}, ...
                "TopP", {1}, ...
    ...
    "ReasoningEffort", struct( ...
        "Input",{{"APIKey","this-is-not-a-real-key","ModelName","gpt-5.2","ReasoningEffort","auto"}}, ...
        "ExpectedWarning", '', ...
        "VerifyProperties", struct( ...
                "Temperature", {1}, ...
                "TopP", {1}, ...
...
invalidConstructorInput = struct( ...
    ...
    ...
    "InvalidReasoningEffortValue",struct( ...
        "Input",{{ "ReasoningEffort" "invalid" }},...
        "Error","MATLAB:validators:mustBeMember"),...
    ...
    "InvalidReasoningEffortType",struct( ...
        "Input",{{ "ReasoningEffort" 123 }},...
        "Error","MATLAB:validators:mustBeMember"));
end
...
invalidGenerateInput = struct( ...
        ...
        "InvalidSeed",struct( ...
            ...
            "Error","MATLAB:validators:mustBeNumeric"),...
        ...
        "InvalidVerbosityInGenerate",struct( ...
            "Input",{{ validMessages  "Verbosity" "invalid" }},...
            "Error","MATLAB:validators:mustBeMember"),...
        ...
        "InvalidReasoningEffortInGenerate",struct( ...
            "Input",{{ validMessages  "ReasoningEffort" "invalid" }},...
            "Error","MATLAB:validators:mustBeMember"));   
end
